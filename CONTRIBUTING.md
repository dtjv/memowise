...
1. Make commits to your feature branch. Prefix each commit like so:
  ...
  - (test) ...
  - (doc) ...
1. When you've finished with your fix or feature, Rebase upstream changes into your branch. submit a [pull request](https://github.com/wonky-mongoose/wonky-mongoose/compare)
...
```
git remote add upstream https://github.com/wonky-mongoose/wonky-mongoose.git
```
...
1. Run the [tests](https://github.com/cucumber/cucumber-js) before submitting a pull request.
...
- [ ] Did I cut my work branch off of develop (don't cut new branches from existing feature branches or master)?
